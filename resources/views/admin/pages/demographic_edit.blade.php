      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ url(route('update_demographic', $demographic->id)) }}" method="POST">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 ...
                 <textarea id="Info" name="question"  required="required" class="resizable_textarea form-control">{{ $demographic->question }}</textarea>
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="small_info" class="form-control col-md-7 col-xs-12" type="text" name="small_info" value="{{ $demographic->small_info }}">
              </div>
            </div>
